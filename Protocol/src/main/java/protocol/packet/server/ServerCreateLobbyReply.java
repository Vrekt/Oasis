...
/**
 * Sent in response to {@link protocol.packet.client.ClientCreateLobby}
 */
public final class ServerCreateLobbyReply extends Packet {
     ...
     */
    public ServerCreateLobbyReply(int lobbyId, int entityId) {
     ...
     */
    public ServerCreateLobbyReply(boolean allowed, String notAllowedReason) {
     ...
     */
    public ServerCreateLobbyReply(ByteBuf buffer, ServerPacketHandler handler) {
        super(buffer);
        handler.handleCreateLobbyReply(this);
    }
